package org.example.Game.Model.Element.Pipe;
...
public class Pipe implements Element {
  ...
  public Pipe(Position position, int tileSize, int width, int height, String resource) {
    this.position = position;
    this.sizeX = tileSize * width;
    this.sizeY = tileSize * height;
