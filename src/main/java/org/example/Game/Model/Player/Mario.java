...
public class Mario implements Element, Player {
  ...
  private final Animation marioAnimation;

  private ImageView shape;

  public Mario(Position position, int tileSize) {
    ...
    this.marioAnimation = getAnimation();
  }
  ...
  public Animation getAnimation() {
    ...
    return new Animation(shape, idleImageRight, idleImageLeft, runningRightFrames, runningLeftFrames, jumpingFrame, jumpingRightFrame, jumpingLeftFrame);
  }
